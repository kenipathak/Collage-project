...
?>
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Pick The Best Product For <br>Your Home</h5>
                              <div class="bottom-info" >
                                 <p><font size="5px"><b>Welcome to 
								 At   decor,we strive to inspire and help you create a beautiful home and your own space filled with happiness.We believe in beautiful homes and are true passionate handicrafts lover.</b></font></p>
                              </div>
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="showpiece.php"><img src="images/p4.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Showpiece</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="light.php"><img src="images/a2.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Light-Brite</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="walldecal.php"><img src="images/p22.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Wall decal</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <a href="unique.php"><img src="images/a4.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Unique-tunique</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <a href="gifts.php"><img src="images/a5.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Gifts</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <a href="ideols.php"><img src="images/a6.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Ideols</h4>
                  </div>
               </div>
               ...
               <ul id="flexiselDemo1">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Light Bright</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="light.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Showpiece</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="showpiece.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Wall Decal</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="walldecal.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid ">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Unique-Tunique</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="unique.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Gifts</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="gifts.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid ">
                        ...
                        <div class="banner-right-icon">
                           <h4 class="pt-3" align="center">Ideols</h4>
                        </div>
                        <div class="outs_more-buttn" align="center">
                           <a href="ideols.php">Shop Now</a>
                        </div>
                     </div>
                  </li>
               </ul>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="images/b3.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="images/p3.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="images/p13.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="images/p30.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="images/p31.jpg" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span> velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
            ...
            <div class="row">
               ...
               <div class="col-lg-6 agileits-toys-right">
                  <div class="sub-agile-info-toys">
                     ...
                     <div class="clients_more-buttn">
                        <a href="ideols.php" class="mb-0">Shop Now</a>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">About Products</h3>
