	...
	<!-- banner -->
      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            <ul class="short_ls">
               ...
               <li>
                  <a href="showpiece.php">Showpiece</a>
               </li>
            </ul>
         </div>
      </div>
      <!-- //short-->
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Showpiece</h3>
            <div class="row">
               <div class="row text-center">
                  <?php
                  $sel="select * from product_table where p_type like 'Showpiece'";
                  $exe=$conn->query($sel);
