            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.php">Toy-Shop</a></h1>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-3 right-side-cart">
                     <div class="cart-icons">
                        <ul>
                           ...
                           <li>
                              <button type="button" data-toggle="modal" data-target="#exampleModal"><span class="far fa-user" href="login.php"></span></button>
                           </li>
