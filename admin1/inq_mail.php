                        ...
                        <div class="wthree_general">
                            <div class="grid-1 graph-form agile_info_shadow">
                                <h3 class="w3_inner_tittle two">Send Reply</h3>
                                    ...
                                    <?php
                                        $i_id=$_REQUEST['imail'];
                                        $sel="select * from inquiry_table where i_id='$i_id'";  //querry
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">                           
                                                    ...
                                                    <input type="text" name="toid" class="form-control1 icon" value="<?php echo $fetch->email;?>" placeholder="Email Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="subject" class="form-control1" id="focusedinput" value="<?php echo $fetch->text;?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
