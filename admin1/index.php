<?php
	            //server name/username/pass/db name
...
if(isset($_REQUEST['submit']))
{
	...
	$sel="select * from admin_table where uname='$uname' and pwd='$pwd'";
	$exe=$conn->query($sel);
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href="main-page.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>HOME DECOR </a></h1></li>
...
<div class="copyrights">
	 <p>© 2019 Home-Decor. All Rights Reserved | Design by  <a href="http://localhost/kite/toys/index.php" target="_blank">Home-Decor</a> </p>
</div>	
