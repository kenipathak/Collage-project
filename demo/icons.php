...
<html lang="zxx">
<head>
<title>Esteem  An Admin Panel Category Flat Bootstrap Responsive Website Template | Icons  :: w3layouts</title>
<!-- custom-theme -->
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Font Awesome Icons</h2>

							<!--/icons-->
				<div class="agile_icons_wthree ">
					 <div class="grid_3 grid_4 agile_info_icons_wthree agile_info_shadow ">
						<div class="icons">
