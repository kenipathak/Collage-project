...
$conn=new MySQLi('localhost','root','','home_decor');
												...
												<div class="signin-form profile">
													...
													<div class="login-form">
														<form action="" method="post">
															<input type="text" name="uname" placeholder="User Name" required="" value="<?php if(isset($_COOKIE['uname'])){ echo $_COOKIE['uname'];}?>">
															<input type="password" name="pwd" placeholder="Password" required="" value="<?php if(isset($_COOKIE['pwd'])){ echo $_COOKIE['pwd'];}?>">
															<div class="form-group">
                    											<div class="form-check">
                   												    <input class="form-check-input" type="checkbox" name="rm" id="gridCheck">
